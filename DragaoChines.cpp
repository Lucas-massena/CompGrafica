...
//Shaders
//Vertex Shader — sem mudanças, apenas passa posição e normal
...
int main() {
    ...
    GLFWwindow* w = glfwCreateWindow(1200, 1000, "Dragao Chines", nullptr, nullptr);
    ...
    std::vector<Vertex> verts;
    std::vector<unsigned> idx;
    LoadOBJ("models/dragon.obj", verts, idx);
